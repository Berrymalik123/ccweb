...
const [open, setOpen] = useState(false);
  ...
  return (
    <header className="sticky top-0 z-50 bg-white  shadow">
      <nav className="max-w-8x1 mx-auto px-10 flex items-center justify-between h-24">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <div className="flex gap-3 text-gray-600 ">
            ...
            <FaInstagram className="float-icon cursor-pointer h-14  w-5 text-pink-600 hover:text-gray-600" />
            <FaLinkedinIn className="float-icon cursor-pointer h-14  w-5 text-blue-700 hover:text-gray-600" />
            <FaTiktok className="float-icon cursor-pointer h-14  w-5 text-black hover:text-gray-600" />
            <FaYoutube className="float-icon cursor-pointer h-14 w-7 text-red-600 hover:text-gray-600" />
          </div>
              ...
              <AnimatePresence>
                {megaOpen && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 15 }}
                    className="absolute top-full left-0 w-175 bg-white text-gray-800 shadow-xl rounded-lg p-6 grid grid-cols-3 gap-6 z-50"
                  >
                    {/* Column 1 */}
                    <div>
