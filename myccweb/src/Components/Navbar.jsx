...
const [open, setOpen] = useState(false);
  ...
  <div className="flex items-center gap-8"> 
        ...
        <AnimatePresence>
          {megaOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 15 }}
              className="absolute top-full left-1/2 -translate-x-1/2 w-[600px] bg-white text-gray-800 shadow-xl rounded-lg p-6 grid grid-cols-3 gap-6 z-50"
            >
              <div>
    ...
    <div className="hidden md:flex items-center font-medium">
      <NavLink to="/tutorials" className={({ isActive }) => `${navLink} hover:bg-yellow-400 hover:text-white ${isActive ? active : ""}`}>
        Tutorials
      </NavLink>
      <NavLink to="/blog" className={({ isActive }) => `${navLink} hover:bg-yellow-400 hover:text-white ${isActive ? active : ""}`}>
        Blog
      </NavLink>
      <NavLink to="/contact" className={({ isActive }) => `${navLink} hover:bg-yellow-400 hover:text-white ${isActive ? active : ""}`}>
        Contact
      </NavLink>
    </div>
  </div>
